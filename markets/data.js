...
(() => {
  ...
  window.ZM_EVENTS = [
    ...
    },
    {
      ...
      icon: "🎬",
      title: L(
        "Попадёт ли славянский фильм в номинацию «Оскара» за лучший международный фильм?",
        "Чи потрапить слов'янський фільм до номінації «Оскара» за найкращий міжнародний фільм?",
        "Ці трапіць славянскі фільм у намінацыю «Оскара» за лепшы міжнародны фільм?",
        "Will a Slavic film get an Oscar nomination for Best International Feature?"
      ),
